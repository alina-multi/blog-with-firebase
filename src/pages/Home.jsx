    ...
    <>
      ...
      <div className="mx-auto max-w-7xl pb-24 pt-10 sm:pb-32 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-40 ">
        <div className="px-6 lg:py-3 ">
          <div className="mx-auto max-w-2xl">
            <div className="max-w-lg">
              ...
              Read posts from the community and share your own ideas. To get
              ...
              <div className="mt-10 flex items-center gap-x-6">
                <a
                  href="/posts"
                  className="rounded-sm bg-sky-600 px-3.5 py-2.5 text-sm font-semibold text-zinc-100 shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                 Go to Posts
                </a>
                <a
        ...
        <div className="mt-20 sm:mt-24 md:mx-auto md:max-w-2xl lg:mx-0 lg:mt-0 lg:w-screen">
          <div
            className="absolute inset-y-0 right-1/2 -z-10 -mr-10 w-[200%] skew-x-[-30deg] bg-zinc-900 shadow-xl shadow-indigo-600/10 ring-1 ring-zinc-700 md:-mr-20 lg:-mr-36"
            aria-hidden="true"
          />
