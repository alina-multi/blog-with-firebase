...
export default function Contact() {
  return (
    ...
    <div className="relative isolate bg-zinc-900  h-screen overflow-hidden">
        ...
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <div className="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-white/5 lg:w-1/2">
              ...
              >
                <div
                  className="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-br from-sky-400 to-sky-500 opacity-20"
                  style={{
                    clipPath:
            ...
            <dl className="mt-10 space-y-4 text-base leading-7 text-zinc-300">
              <div className="flex gap-x-4">
                <dt className="flex-none">
                  ...
                  <BuildingOffice2Icon className="h-7 w-6 text-zinc-400" aria-hidden="true" />
                </dt>
                <dd>
                  545 Mavis Island
                  <br />
              ...
              <div className="flex gap-x-4">
                <dt className="flex-none">
                  ...
                  <PhoneIcon className="h-7 w-6 text-zinc-400" aria-hidden="true" />
                </dt>
                <dd>
              ...
              <div className="flex gap-x-4">
                <dt className="flex-none">
                  ...
                  <EnvelopeIcon className="h-7 w-6 text-zinc-400" aria-hidden="true" />
                </dt>
                <dd>
